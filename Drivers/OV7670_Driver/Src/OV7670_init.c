 ...
 * @return OV7670_error_t error code
 */
 ...
 */
static OV7670_error_t OV7670_init_interrupts(void)
{
...
/**
 * @brief Initialize the driver's i2c peripheral.
 * 
 * @param PIN Set of pins used for the camera module
 * @return OV7670_error_t 
 */
static OV7670_error_t OV7670_init_i2c(const OV7670_pins_t *PIN)
{
    ...
    OV7670_hi2c.Init.OwnAddress1 = 0;
...
void OV7670_deinit_camera(void)
{
